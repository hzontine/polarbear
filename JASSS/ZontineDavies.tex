...
\title{``The Hidden Trump Model": Modeling Political Uncertainty}
...
\author[1]{Hannah Zontine}
\author[1]{Stephen Davies}
\affil[1]{University of Mary Washintgon}
%\affil[2]{University of Mary Washintgon}
...
\bibliography{ZontineDavies}{} % Please set the right name for your bib file
